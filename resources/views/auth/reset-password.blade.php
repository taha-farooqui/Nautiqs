<x-guest-layout :title="__('Reset password') . ' · Nautiqs'">
    <div class="max-w-md">
        <h1 class="text-3xl font-bold text-gray-900 mb-1">{{ __('Choose a new password') }}</h1>
        <p class="text-gray-500 mb-8">{{ __("Pick something strong you'll remember.") }}</p>
