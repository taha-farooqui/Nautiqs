...
class QuoteCalculator
{
    ...
    public function compute(array $input, Company $company): array
    {
        ...
        //
        // A euro amount comes straight off the price and VAT is then worked out
        // on what's left — no basis juggling. Typing "500 EUR off" removes 500
        // from the line, and the VAT below is charged on the discounted figure.
